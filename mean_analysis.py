...
# def analyze_mean_imputation(filepath, app, target_column):
...
#     return {
#         'rmse': rmse,
#         'imputed_csv_path': url_for('static', filename='uploads/mean_imputed.csv'),
...
#     # Menghitung RMSE untuk hasil imputasi
#     # Temukan nilai yang hilang di X_encoded untuk mendapatkan nilai asli
...
#         'rmse': rmse,
#         'imputed_csv_path': url_for('static', filename='uploads/mean_imputed.csv'),
#         'imputed_excel_path': url_for('static', filename='uploads/mean_imputed.xlsx'),
#         'imputed_data': df_imputed.to_html(classes="table table-striped", index=False)
#     }
