...
# def analyze_logistic_regression_imputation(filepath, app, target_column):
...
#     # Imputasi data
#     data_imputed_lr = logistic_regression_impute(pd.DataFrame(X_initial_imputed, columns=X.columns), X)

#     # Menghitung RMSE untuk hasil imputasi
#     numerical_cols = X.select_dtypes(include=[np.number]).columns
#     rmse = np.sqrt(mean_squared_error(X[numerical_cols], data_imputed_lr[numerical_cols]))

#     # Simpan dataset yang sudah diimputasi
#     df_imputed = pd.DataFrame(data_imputed_lr, columns=X.columns)
...
#     return {
#         'rmse': rmse,
#         'imputed_csv_path': url_for('static', filename='uploads/logistic_regression_imputed.csv'),
...
#         'rmse': rmse,
#         'imputed_csv_path': url_for('static', filename='uploads/logistic_regression_imputed.csv'),
#         'imputed_excel_path': url_for('static', filename='uploads/logistic_regression_imputed.xlsx'),
#         'imputed_data': df_imputed.to_html(classes="table table-striped", index=False)
#     }
