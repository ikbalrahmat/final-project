...
# from decision_tree_analysis import analyze_decision_tree
# from logistic_regression_analysis import analyze_logistic_regression
# from random_forest_analysis import analyze_random_forest
# from knn_analysis import analyze_knn
# from naive_bayes_analysis import analyze_naive_bayes
# from mode_analysis import analyze_mode  # Import mode analysis function
...
#     decision_tree_result = analyze_decision_tree(filepath, app, target_column)
#     logistic_regression_result = analyze_logistic_regression(filepath, app, target_column)
#     random_forest_result = analyze_random_forest(filepath, app, target_column)
#     knn_result = analyze_knn(filepath, app, target_column)
#     naive_bayes_result = analyze_naive_bayes(filepath, app, target_column)
#     mode_result = analyze_mode(filepath, app, target_column)
...
#     return render_template('imputation_result.html', datasets=datasets)
...
# from knn_analysis import analyze_knn
# from naive_bayes_analysis import analyze_naive_bayes
# from mode_analysis import analyze_mode
...
#     return render_template('imputation_results.html', datasets=datasets)
